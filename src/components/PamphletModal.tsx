...
import { PAMPHLET_HTML_CONTENT } from '../constants';
...
const PamphletModal: React.FC<PamphletModalProps> = ({ isOpen, onClose, lang }) => {
  ...
  return (
    <div 
      className="fixed inset-0 z-[150] flex items-center justify-center p-0 md:p-6 lg:p-12 animate-in fade-in duration-300"
      role="dialog"
      aria-modal="true"
      ...
      <div className="relative w-full h-full max-w-5xl bg-white md:rounded-3xl shadow-2xl overflow-hidden flex flex-col animate-in zoom-in-95 duration-300 border border-white/10">
        ...
        <header className="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-white z-20">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 id="pamphlet-modal-title" className="font-bold text-slate-900 leading-none">
        ...
        {/* Footer */}
        <footer className="px-6 py-3 bg-white border-t border-slate-100 flex justify-center">
